...
import ru.d78boga.mahabre.world.feature.MapGenMahabreCaves;
import ru.d78boga.mahabre.world.gen.structure.WorldGenMahabreCity;
import ru.d78boga.mahabre.world.gen.structure.mWorldGenStructure;
...
public class ChunkGeneratorMahabre implements IChunkGenerator {
	...
	private TerrainGeneratorMahabre terraingen = new TerrainGeneratorMahabre();
	private mWorldGenStructure genCity;
	...
	public ChunkGeneratorMahabre(World world) {
		...
		genCity = new WorldGenMahabreCity(world);
	}
